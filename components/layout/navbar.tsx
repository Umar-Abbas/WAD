    ...
    >
      <div className="container mx-auto max-w-[1280px]">
        <div className="flex justify-between w-full py-4 align-middle bg-black-1">
          ...
          <button
            onClick={() => open()}
            className="wadbtn inline-flex w-auto items-center justify-center gap-x-3 rounded-full px-4 py-2.5 text-center font-medium text-white transition transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-0 focus:ring-offset-0 dark:focus:ring-0 sm:w-[150px]"
            style={{
              background:
