      ...
      <section>
        <div className="Satoshi relative mx-auto max-w-[1280px]">
          ...
          <div
            ...
            id="tokenomics"
          >
            <div className="mb-5 md:mb-8 md:text-3xl lg:mb-12 text-center">
            ...
            <div className="flex flex-wrap !justify-center gap-4 lg:items-center lg:gap-10">
              {tokenomics?.map((datacard, idx) => {
                return (
                  <>
                    <div className="h-[250px] w-full overflow-hidden rounded-[24PX] bg-[url(/images/cardBg.svg)] bg-cover object-cover p-6 sm:w-[45%] md:h-[308px] lg:w-[30%] xl:w-[31%]">
