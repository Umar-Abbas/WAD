          ...
          <div className="flex w-full flex-wrap gap-4 md:flex-nowrap">
            <div className="w-full sm:w-1/2  lg:w-[27%]">
              <div
                ...
                data-aos-delay="100"
                className="festuredC mb-4 h-[220px] w-full overflow-hidden rounded-[24PX] bg-white p-10 shadow-mapcard dark:bg-card-bg dark:shadow-card md:mb-0 lg:p-8"
              >
                <ul>
              ...
              <div
                ...
                data-aos-duration="1000"
                data-aos-delay="100"
                className="festuredC h-[220px] w-full overflow-hidden rounded-[24PX] bg-white p-10 shadow-mapcard dark:bg-card-bg dark:shadow-card md:mt-10 lg:mt-28 lg:p-8"
              >
                <ul>
                  <li className="mb-2 mt-1 list-disc text-sm font-normal text-[#000] dark:text-white md:text-[16px] ">
            ...
            <div className="w-full sm:w-1/2 lg:w-[27%]">
              <div  data-aos="fade-left"
                data-aos-duration="1000"
                data-aos-delay="100" className="festuredC mb-4  h-[220px] w-full overflow-hidden rounded-[24PX] bg-white p-10 shadow-mapcard dark:bg-card-bg dark:shadow-card md:mb-0 md:mt-14 lg:mt-28 lg:p-8">
                <ul>
                  <li className="mb-2 mt-1 list-disc text-sm font-normal text-[#000] dark:text-white md:text-[16px] ">
              ...
              <div  data-aos="fade-left"
                data-aos-duration="1000"
                data-aos-delay="100" className="festuredC h-[220px] w-full overflow-hidden rounded-[24PX] bg-white p-10 shadow-mapcard dark:bg-card-bg dark:shadow-card md:mt-14 lg:mt-28 lg:p-8">
                <ul>
                  <li className="mb-2 mt-1 list-disc text-sm font-normal text-[#000] dark:text-white md:text-[16px] ">
